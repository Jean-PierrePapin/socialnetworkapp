    ...
    <Page title="Edit Post">
      <form onSubmit={submitHandler}>
        <div className="form-group">
          ...
          {state.title.hasErrors && <div className="alert alert-danger small liveValideMessage">{state.title.message}</div>}
        </div>
        ...
        <div className="form-group">
          ...
          {state.body.hasErrors && <div className="alert alert-danger small liveValideMessage">{state.body.message}</div>}
        </div>
